...
export const mockProductResponse: ProductsResponse = {
  totalPages: 10,
  items: [mockProduct],
};

export const mockProductPagination: ProductPagination = {
  info: {
    page: 0,
    pageSize: 5,
    pages: 10
...
export const mockPagininationWithoutPrev = {
  info: {
    page: 0,
    pageSize: 5,
    pages: 10
...
export const mockPagininationWithoutNext = {
  info: {
    page: 49,
    pageSize: 5,
    pages: 50
